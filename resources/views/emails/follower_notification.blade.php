...
<body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
    <div style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        ...
        <p>
            <strong>{{ $follower->display_name }} (@{{ $follower->username }})</strong> ahora te sigue en <strong>Unigrami</strong>.
        </p>
        ...
        <p>
            <a href="{{ url('/profile/' . $follower->username) }}" style="color: #e1306c; font-weight: bold;">
                Ver perfil de @{{ $follower->username }}
            </a>
        </p>
